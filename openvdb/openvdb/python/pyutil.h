...
struct GridTraitsBase
{
    ...
    /// (e.g., "FloatGrid" for laovdb::FloatGrid).
    ///
    ...
    {
        return laovdb::typeNameAsString<typename GridType::ValueType>();
    }
...
GRID_TRAITS(laovdb::FloatGrid, "FloatGrid");
GRID_TRAITS(laovdb::Vec3SGrid, "Vec3SGrid");
GRID_TRAITS(laovdb::BoolGrid, "BoolGrid");
#ifdef PY_OPENVDB_WRAP_ALL_GRID_TYPES
GRID_TRAITS(laovdb::DoubleGrid, "DoubleGrid");
GRID_TRAITS(laovdb::Int32Grid, "Int32Grid");
GRID_TRAITS(laovdb::Int64Grid, "Int64Grid");
GRID_TRAITS(laovdb::Vec3IGrid, "Vec3IGrid");
GRID_TRAITS(laovdb::Vec3DGrid, "Vec3DGrid");
GRID_TRAITS(laovdb::points::PointDataGrid, "PointDataGrid");
#endif
...
/// boost::shared_ptr<laovdb::Grid<laovdb::tree::Tree<laovdb::tree::RootNode<...".
template<typename T>
inline T
extractArg(
    ...
    const char* expectedType = nullptr)
{
    ...
    if (!val.check()) {
        ...
        os << "expected ";
        if (expectedType) os << expectedType; else os << laovdb::typeNameAsString<T>();
