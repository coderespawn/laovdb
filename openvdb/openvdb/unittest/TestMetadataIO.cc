...
template<typename T> struct Value<laovdb::math::Vec2<T>> {
    using ValueType = laovdb::math::Vec2<T>;
    static ValueType create(int i) { return ValueType(i, i+1); }
};
template<typename T> struct Value<laovdb::math::Vec3<T>> {
    using ValueType = laovdb::math::Vec3<T>;
    static ValueType create(int i) { return ValueType(i, i+1, i+2); }
};
template<typename T> struct Value<laovdb::math::Vec4<T>> {
    using ValueType = laovdb::math::Vec4<T>;
...
TEST_F(TestMetadataIO, testVec3R) { test<laovdb::Vec3R>(); }
TEST_F(TestMetadataIO, testMultipleVec3R) { testMultiple<laovdb::Vec3R>(); }

TEST_F(TestMetadataIO, testVec2i) { test<laovdb::Vec2i>(); }
TEST_F(TestMetadataIO, testMultipleVec2i) { testMultiple<laovdb::Vec2i>(); }

TEST_F(TestMetadataIO, testVec4d) { test<laovdb::Vec4d>(); }
TEST_F(TestMetadataIO, testMultipleVec4d) { testMultiple<laovdb::Vec4d>(); }
