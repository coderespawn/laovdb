...
TEST_F(TestVec2Metadata, testVec2i)
{
    ...
    Metadata::Ptr m(new Vec2IMetadata(laovdb::Vec2i(1, 1)));
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec2i(1, 1));
    s->value() = laovdb::Vec2i(2, 2);
    EXPECT_TRUE(s->value() == laovdb::Vec2i(2, 2));
...
TEST_F(TestVec2Metadata, testVec2s)
{
    ...
    Metadata::Ptr m(new Vec2SMetadata(laovdb::Vec2s(1, 1)));
    Metadata::Ptr m2 = m->copy();
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec2s(1, 1));
    s->value() = laovdb::Vec2s(2, 2);
    EXPECT_TRUE(s->value() == laovdb::Vec2s(2, 2));
...
TEST_F(TestVec2Metadata, testVec2d)
{
    ...
    Metadata::Ptr m(new Vec2DMetadata(laovdb::Vec2d(1, 1)));
    Metadata::Ptr m2 = m->copy();
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec2d(1, 1));
    s->value() = laovdb::Vec2d(2, 2);
    EXPECT_TRUE(s->value() == laovdb::Vec2d(2, 2));
