...
TEST_F(TestVec3Metadata, testVec3i)
{
    ...
    Metadata::Ptr m(new Vec3IMetadata(laovdb::Vec3i(1, 1, 1)));
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec3i(1, 1, 1));
    s->value() = laovdb::Vec3i(3, 3, 3);
    EXPECT_TRUE(s->value() == laovdb::Vec3i(3, 3, 3));
...
TEST_F(TestVec3Metadata, testVec3s)
{
    ...
    Metadata::Ptr m(new Vec3SMetadata(laovdb::Vec3s(1, 1, 1)));
    Metadata::Ptr m3 = m->copy();
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec3s(1, 1, 1));
    s->value() = laovdb::Vec3s(3, 3, 3);
    EXPECT_TRUE(s->value() == laovdb::Vec3s(3, 3, 3));
...
TEST_F(TestVec3Metadata, testVec3d)
{
    ...
    Metadata::Ptr m(new Vec3DMetadata(laovdb::Vec3d(1, 1, 1)));
    Metadata::Ptr m3 = m->copy();
    ...
    EXPECT_TRUE(s->value() == laovdb::Vec3d(1, 1, 1));
    s->value() = laovdb::Vec3d(3, 3, 3);
    EXPECT_TRUE(s->value() == laovdb::Vec3d(3, 3, 3));
